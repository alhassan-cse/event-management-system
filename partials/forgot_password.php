...
if(isset($_POST['form'])){
    $message  = $authentication->forgotPassword($_POST);
} 
?>
<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">
    <div class="lh-100">
        <h6 class="mb-0 text-white lh-100">Forgot Password</h6>
    </div>
</div>
        ...
        <form action="" method="POST" id="singInForm">
            ...
            <div class="form-group row">
                <div class="col-sm-10 offset-sm-2">
                    <button type="submit" name="form" class="btn btn-primary" id="singIn">Submit</button>
                </div>
            </div>
