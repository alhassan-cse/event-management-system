...
$userTypeArr = [1=>'Admin', 2=>'Customer'];
$sql = "SELECT * FROM users ORDER BY `id` DESC";
$users = $apps->multipuleDisplay($sql); 
 
if(isset($_SESSION['user_type']) && $_SESSION['user_type']==1){
    ?>
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">Users</h6>
        </div>
    </div>
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="d-flex flex-row-reverse bd-highlight mb-4">
            <div class="btn-group">
                <a href="create_user.php" class="btn btn-primary btn-sm">Add new</a> 
            </div>
        </div> 
        <table id="example" class="table table-striped table-bordered nowrap data-table" style="width:100%">
            ...
            <tbody>
                ...
                ?>
                <tr id="user_id_<?php echo $key++;?>">
                    <td><?php echo $key++;?></td>
                    <td><?php echo mb_strimwidth($row['name'], 0, 20, "...");?></td>
                    <td><?php echo $userTypeArr[$row['user_type']];?></td>
                    ...
                    <td>
                        ...
                        if($row['status'] ==1){
                            ?>
                            <a href="javascript:void(0)" data-url="user_status.php?id=<?php echo $row['id']?>&status=0" class="url_action_click">
                            ...
                            ?>
                            <a href="javascript:void(0)" data-url="user_status.php?id=<?php echo $row['id']?>&status=1" class="url_action_click">
                        ...
                        ?>
                        <a href="javascript:void(0)" data-url="user_remove.php?id=<?php echo $row['id']?>" class="url_action_click">
