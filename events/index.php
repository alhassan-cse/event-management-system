...
if(isset($_SESSION['id'])){
    if($_SESSION['user_type']==1)
    {
        ...
        $status = "`status` = 1 AND";
        $expire_date = "AND `expire_date` > '$date' ";
    }
}
else{
    $status = '';
...
$sql = "SELECT * FROM events WHERE $status `deleted_at` IS NULL $expire_date ORDER BY `id` DESC";
...
if(isset($_SESSION['user_type']) && $_SESSION['user_type']==1)
{
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="d-flex flex-row-reverse bd-highlight mb-4">
            <div class="btn-group">
                <a href="event.php" class="btn btn-primary btn-sm">Add new</a> 
            </div>
        </div> 
            ...
            <tbody>
                ...
                <tr id="user_id_<?php echo $key++;?>">
                    ...
                    <td>
                        ...
                        if($row['status'] ==1){
                            ?>
                            <a href="javascript:void(0)" data-url="status.php?id=<?php echo $row['id']?>&status=0" class="url_action_click">
                            ...
                            ?>
                            <a href="javascript:void(0)" data-url="status.php?id=<?php echo $row['id']?>&status=1" class="url_action_click">
                        ...
                        ?>
                        <a href="javascript:void(0)" data-url="remove.php?id=<?php echo $row['id']?>" id="" class="url_action_click">
